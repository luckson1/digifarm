...
export default function ProductCard({product}: {
  ...
  return (
   <Card onClick={()=> {setProduct(product);router.replace("/product") }} className='cursor-pointer'>
    <CardHeader>
...
Deal
    ...
    <CardContent className='text-base space-y-2'>
        <Image src={product.imageUrl} alt={product.name}  width={300} height={300} loading='lazy' quality={30} className='w-full h-56 rounded-md'/>
