    ...
    <>
      <div className="flex-col flex">
        ...
        <div className="flex-1 space-y-4 p-8 pt-6">
          <div className="flex flex-col md:flex-row items-center justify-between md:space-y-2">
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">KES 405,231.89</div>
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                ...
                <Card className="col-span-3">
                  <CardHeader>
                    ...
                    <CardDescription>
                      You made 265 purchases this month.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <RecentPurchases />
