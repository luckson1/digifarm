...
export function UserLoginForm({ className, ...props }: UserAuthFormProps) {
  ...
  const [ setAuth, setFarmer, setBiz]=useStore((store)=> [store.login ,store.setFarmerForm, store.setBizForm])
 ...
 type Values= z.infer<typeof formSchema>;
  const {handleSubmit,  formState:{errors}, register}=useForm<Values>({
